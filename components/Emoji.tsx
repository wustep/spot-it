		...
		return (
			<span
				className={cn(
					...
					// Subtle white glow for dark mode visibility of dark symbols
					"dark:[text-shadow:_0_0_2px_rgba(255,255,255,0.6)]",
					className
				)}
				style={{ fontSize: size }}
			>
	...
	return (
		<img
			...
			className={cn(
				...
				// Subtle white glow for dark mode visibility of dark symbols
				"dark:[filter:_drop-shadow(0_0_1px_rgba(255,255,255,0.6))]",
				className
			)}
			style={{
				width: size,
